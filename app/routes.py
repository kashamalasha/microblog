...
def index():
    ...
    return render_template('index.html.j2', title='Home', posts=posts, form=form)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # security redirect to next page
...
def explore():
    ...
    return render_template(url_for('index'), title='Explore', posts=posts)
